...
To access the project's [SemanticVersion](src/main/java/jvmlabs/build/version/SemanticVersion.java) you can use
...
val semanticVersion = rootProject.the<SemanticVersionExtension>().value
println(semanticVersion.get().toExtendedString())
```
